...
import com.tobacco.xinyiyun.knowledge.mvp.home.fragment.CultivationFragment;
...
public class CultivationPresenter extends BasePresenter<CultivationModel, CultivationFragment> {

    public void getCultivationList(String wzlx) {
        getModel().getCultivationList(wzlx, null)
