...
import com.tobacco.xinyiyun.knowledge.mvp.home.BakeSearchActivity;
...
public class BakeSearchPresenter extends BasePresenter<BakeModel, BakeSearchActivity> {

    public void getBakeList(String wzlx, String yypz, String yybw, String context, String hkkf, String hkhsl) {
        getModel().getBakeList(wzlx, yypz, yybw, context, hkkf, hkhsl)
