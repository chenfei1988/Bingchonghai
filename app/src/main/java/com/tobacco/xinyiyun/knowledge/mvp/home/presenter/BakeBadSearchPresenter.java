...
import com.tobacco.xinyiyun.knowledge.mvp.home.BakeBadSearchActivity;
...
public class BakeBadSearchPresenter extends BasePresenter<BakeModel, BakeBadSearchActivity> {

    public void getBakeList(String wzlx) {
        getModel().getBakeList(wzlx, null, null, null)
